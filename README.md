...
rtmp {
    server {
        ...
        application stream {
            ...
            exec ffmpeg -i rtmp://localhost:1935/stream/$name -i /opt/images/jimmy.png
              -filter_complex "overlay=10:10,split=1[jimmy]"
              -map '[jimmy]' -map 0:a -s 1920x1080 -c:v libx264 -c:a aac -g 30 -r 30 -tune zerolatency -preset veryfast -crf 23 -f flv rtmp://localhost:1935/hls/$name_wm
...
application stream {
    ...
    exec ffmpeg -i rtmp://localhost:1935/stream/$name -i /opt/images/jimmy.png
      -filter_complex "overlay=10:10,split=1[jimmy]"
      -map '[jimmy]' -map 0:a -s 1920x1080 -c:v libx264 -c:a aac -g 30 -r 30 -tune zerolatency -preset veryfast -crf 23 -f flv rtmp://live-push.tencent.com/stream/$name_wm
    ...
    exec ffmpeg -i rtmp://localhost:1935/stream/$name -i /opt/images/jimmy.png
      -filter_complex "overlay=10:10,split=1[jimmy]"
      -map '[jimmy]' -map 0:a -s 1920x1080 -c:v libx264 -c:a aac -g 30 -r 30 -tune zerolatency -preset veryfast -crf 23 -f flv rtmp://live-push.aliyun.com/stream/$name_wm
